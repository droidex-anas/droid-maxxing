    ...
    <section className="mt-7 first:mt-0">
      <div className="flex items-center gap-2">
        <button
          ...
          className="group -ml-1 flex min-w-0 items-center gap-1.5 rounded-lg px-1 py-1 text-left transition-colors hover:bg-droid-elevated/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-droid-border-hover"
        >
          <ChevronDown
